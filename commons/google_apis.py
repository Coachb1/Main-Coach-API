...
from vertexai.generative_models import GenerativeModel, Content, Part, SafetySetting, GenerationConfig
        ...
        while retry < max_retry:
            ...
            try:
                ...
                responses = chat.send_message(current_user_response, 
                                              generation_config=GenerationConfig(response_mime_type="application/json" if json_ouput else "text/plain")
                                              )
