...
class ManagerSkills:
    ...
    PERSONALITY = {
        ...
        "Concision": "Clarity and concision is the ability to communicate information clearly and precisely, focusing on essential points while avoiding unnecessary complexity or ambiguity.",
    }
...
class SalesManagerSkills:
    PEOPLE = {
        ...
        "Inspire": "Energize and motivate others through passion, vision, and leading by example.",
    ...
    PARTNERSHIP = {
        "Think Strategic ": "Think Strategic  is the ability to see the big picture and develop long-term plans. It requires the ability to see the big picture, identify opportunities, and develop creative solutions to problems.",
...
class CustomerServiceSkills:
    ...
    PROCESS = {
        ...
        "Concision": "Ability to articulate information succinctly and comprehensibly. By communicating clearly and avoiding jargon, agents can resolve customer queries effectively, ensuring a positive and efficient support experience.",
    ...
    PERSONALITY = {
        ...
        "Will to learn": "Eagerly absorb new information and skills through proactive self-education.",
        "Decisiveness": "Decisiveness is the ability to make decisions quickly and effectively. It is the skill of making well-considered and timely choices, crucial for effective leadership and problem-solving.",
    }
